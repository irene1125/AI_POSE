...
TRAIN_DATA_DIR = os.path.join(DATA_DIR, 'split/task04_train') # /DATA/split/task04_train
PROJECT_DATA_DIR = os.path.join(DATA_DIR, 'train_val') # /DATA/train_val/  ...train/camera

if __name__ == '__main__':
    
    IM_DIR = os.path.join(PROJECT_DATA_DIR, 'train/images')
    yet_im_path = os.listdir(IM_DIR) # /DATA/train_val/train/images 내부 디렉토리명

    LA_PROJ_DIR1 = os.path.join(PROJECT_DATA_DIR, 'train/labels')
    im_name = []
    num = 0
    before = ''
    image_list = []
